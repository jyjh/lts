...
> 📊 **[View the UML Class Diagram](docs/CLASS_DIAGRAM.md)** — Full Mermaid.js class diagram showing inheritance, composition, and aggregation relationships. Also available as a [standalone HTML page](docs/class_diagram.html) for browser viewing.
