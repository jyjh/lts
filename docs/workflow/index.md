...
7. **Review** - `lts.telemetry.GraphPlotter` dashboards expose speed, acceleration, aero forces, normal loads, damper travel, tire slip/forces, drive force, motor RPM, and RPM limiter state.
