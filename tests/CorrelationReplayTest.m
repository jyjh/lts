...
T = table( ...
    ...
    'steer_rad', 'speed_mps', 'vx_mps', 'vy_mps', 'body_slip_rad', ...
...
state = CorrelationStateInitializer.fromReplayProfile(profile, track, []);
...
state = CorrelationStateInitializer.fromReplayProfile(profile, [], []);
...
[stateLog, ~, outputs] = run_correlation( ...
