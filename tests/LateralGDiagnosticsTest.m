...
rawLatG = speed .* yawRate ./ lts.diagnostics.LateralGDiagnostics.g;
steer = atan(rawLatG * lts.diagnostics.LateralGDiagnostics.g * 1.6 ./ speed.^2);
...
yawLatG = speed .* yawRate ./ lts.diagnostics.LateralGDiagnostics.g;
rawLatG = yawLatG + 1.0;
steer = zeros(size(time));
...
events = lts.diagnostics.LateralGDiagnostics.topMismatchEvents( ...
