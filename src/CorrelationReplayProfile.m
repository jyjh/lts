classdef CorrelationReplayProfile
    ...
    % brake_pressure_front_bar, brake_pressure_rear_bar, steer_rad, speed_mps,
    ...
    methods (Static)
        function obj = fromCsv(filepath)
            ...
            obj = CorrelationReplayProfile( ...
                ...
                'BrakePressureFrontBar', CorrelationReplayProfile.readColumn(T, ...
                ...
                'BrakePressureRearBar', CorrelationReplayProfile.readColumn(T, ...
