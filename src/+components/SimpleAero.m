classdef SimpleAero < components.AeroComponent
    ...
    properties
        ClA              = 1.0    % Lift coefficient * area [m^2] (positive = downforce)
    ...
    methods
        function obj = SimpleAero(varargin)
            % SIMPLEAERO Construct with optional name-value pairs
            %   SimpleAero('ClA', 1.0, 'CdA', 0.5, 'xPosition', -0.8)
            if nargin > 0
                for i = 1:2:nargin
