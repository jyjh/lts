classdef DriverModel_legacy < handle
    % DRIVERMODEL_LEGACY Legacy driver model (centerline GGV sweep + Stanley).
    %
    ...
    methods
        function obj = DriverModel_legacy(vehicleManager)
        ...
        function obj = prepareForSimulation(obj, initialState, trackData, dt)
            ...
            obj.inputPlanner = DriverInputPlanner_legacy(obj.vehicleManager, obj);
